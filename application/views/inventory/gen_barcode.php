...
<table align="center" border="0">
  ...
  <tr>
    <td>
      ...
      <td height="20" style="text-align:center" > 
      	...
      	<table>
        <tr>
        	<td><div style=""> <img src="<?php echo $src; ?>" width="200" style="height:20px; width:100px; float:left "/> </div></td>
            <td><div style="font-size: 20px;text-align: center;font-weight:bold">
        <?php echo $q; ?>
      </div></td>
            <td><div style=""> <img src="<?php echo $src; ?>" width="200" style="height:20px; width:100px; float:left "/> </div></td>
        </tr>
  ...
  <tr>
    ...
    <tr>
       <td style="text-align:left;font-size:20px;font-weight:bold;"><?php echo $row->transaction?></td>
       <td style="text-align:right;font-size:20px;font-weight:bold">&nbsp; </td>
       ...
       <tr>
       <td height="18" style="text-align:left;font-size:16px;font-weight:bold"><?php echo strtoupper(date("M",strtotime($row->datetime)));  ?></td>
       <td style="text-align:left;font-size:18px;font-weight:bold"><?php echo strtoupper(date("Y",strtotime($row->datetime)));  ?></td>
       </tr>
       
           <tr>
       <td style="text-align:left;font-size:18px;font-weight:bold;"><?php echo "RQ/PPS"; ?></td>
       <td style="text-align:left;font-size:18px;font-weight:bold;"><?php echo sprintf("%04d", $row->quantity);?>/<?php echo sprintf("%04d", $row->handling_quantity);?></td>
       </tr>
       </table>
 </td></tr>
